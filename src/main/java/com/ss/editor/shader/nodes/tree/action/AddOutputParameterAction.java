 ...
 * @author JavaSaBr
 */
public class AddOutputParameterAction extends AddParameterAction {

    public AddOutputParameterAction(@NotNull final NodeTree<?> nodeTree, @NotNull final TreeNode<?> node) {
        super(nodeTree, node);
    }
