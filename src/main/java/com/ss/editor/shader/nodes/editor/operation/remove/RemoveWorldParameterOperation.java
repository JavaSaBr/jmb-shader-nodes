 ...
 * @author JavaSaBr
 */
public class RemoveWorldParameterOperation extends RemoveUniformOperation {
    ...
    public RemoveWorldParameterOperation(@NotNull final List<ShaderNode> shaderNodes,
