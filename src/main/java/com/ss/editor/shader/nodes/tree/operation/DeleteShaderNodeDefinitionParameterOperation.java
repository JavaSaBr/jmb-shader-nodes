 ...
 * @author JavaSaBr
 */
public class DeleteShaderNodeDefinitionParameterOperation extends AbstractEditorOperation<ChangeConsumer> {
    ...
    public DeleteShaderNodeDefinitionParameterOperation(@NotNull final ShaderNodeDefinitionParameters parameters,
